...
import getOppsResults from '@salesforce/apex/CreateOpportunitiesByMaintenance.getOpportunityResults';
import createJunctionRegisters from '@salesforce/apex/CreateOpportunitiesByMaintenance.createJunctionRegisters';
import { NavigationMixin } from 'lightning/navigation';

export default class CreateOpportunitiesByMaintenance extends NavigationMixin(LightningElement) {
    ...
    searchField(event) {
        ...
        getOppsResults({ selectedOpportunitiesIds: selectRecId, filter: this.currentText, maintenanceId: this.maintenanceId }).then(result => {
    ...
    createRegisters(event) {
        ...
        if (this.selectedIds != '') {
            ...
            createJunctionRegisters({ name: this.name, maintenance: this.maintenanceId, selectedopportunitiesIds: this.selectedIds })
                .then((result) => {
