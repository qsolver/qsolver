...
import getAssetsResults from '@salesforce/apex/createAssetsByOpportunity.getAssetsResults';
import createJunctionRegisters from '@salesforce/apex/createAssetsByOpportunity.createJunctionRegisters';
import { NavigationMixin } from 'lightning/navigation';


export default class CreateAssetsByOpportunityLWC extends NavigationMixin(LightningElement) {
  ...
  searchField(event) {
      ...
      getAssetsResults({selectedAssetsIds: selectRecId, filter: this.currentText, opportunityId: this.opportunityId}).then(result =>{
  ...
  removeRecord (event){
    ...
    createRegisters(event){
        ...
        if(this.selectedIds != ''){
            ...
            createJunctionRegisters({isoCode: this.isoCode, opportunity: this.opportunityId, selectedAssetsIds: this.selectedIds})
            .then((result) => {
