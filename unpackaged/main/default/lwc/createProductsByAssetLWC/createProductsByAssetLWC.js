...
import getProductResults from '@salesforce/apex/createProductsByAsset.getProductResults';
import createJunctionRegisters from '@salesforce/apex/createProductsByAsset.createJunctionRegisters';
import { NavigationMixin } from 'lightning/navigation';

export default class CreateProductsByAssetLWC extends NavigationMixin(LightningElement) {
    ...
    searchField(event) {
        ...
        getProductResults({selectedProductsIds: selectRecId, filter: this.currentText}).then(result =>{
   ...
   setSelectedRecord(event) {
    ...
    createRegisters(event){
        ...
        if(this.selectedIds != ''){
            ...
            createJunctionRegisters({name: this.name, isoCode: this.isoCode, asset: this.assetId, selectedProductsIds: this.selectedIds})
            .then((result) => {
